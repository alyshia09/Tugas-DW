const apiKey = '2d33c44116d949dfab545132241510';  // API key yang Anda dapatkan
const city = 'Jakarta';
...
fetch(apiURL)
    ...
    .then(data => {
        ...
        currentWeatherDiv.innerHTML = `
            ...
            <img src="https:${currentWeather.condition.icon}" alt="ikon cuaca">
            <p> <i class="bi bi-thermometer-half"></i> : ${currentWeather.temp_c}°C</p>
        ...
        data.forecast.forecastday.forEach((day) => {
            ...
            forecastHTML += `
                <div class="day">
                    <h4>${formattedDate}</h4>
                    <p> <i class="bi bi-thermometer-half"></i> Siang: ${day.day.maxtemp_c}°C</p>
                    <p> <i class="bi bi-thermometer-half"></i> Malam: ${day.day.mintemp_c}°C</p>
